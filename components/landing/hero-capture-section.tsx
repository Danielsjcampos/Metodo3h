...
export function HeroCaptureSection({ settings }: { settings?: any }) {
  ...
  return (
    <section className={cn(
      "relative min-h-screen flex flex-col justify-between items-stretch bg-black pt-[140px] sm:pt-[180px] lg:pt-32 pb-12 lg:pb-16",
            ...
            {isStarted && (
              <>
                ...
                {isMuted && (
                  ...
                  >
                    <div className={cn(
                      "bg-[#0088ff] text-white text-center transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] animate-bounce-gentle",
                      isFloating 
