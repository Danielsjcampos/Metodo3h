              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pb-6 border-b border-white/5">
                <div className="space-y-1">
                  ...
                  <div className="flex items-center gap-2 text-xs font-mono text-muted-foreground">
                    ...
                    <span>·</span>
                    <span className="text-[#3B82F6]">Método 3h VOD</span>
                  </div>
                </div>
              ...
              <Tabs defaultValue="description" className="w-full bg-white/[0.01] border border-white/5 rounded-2xl p-6">
                ...
                <TabsContent value="description" className="mt-6 space-y-4">
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Nesta aula abordamos detalhadamente a execução passo a passo do Método 3h. Siga as instruções do vídeo para configurar as dependências gratuitas e preparar a estrutura inicial em menos de 10 minutos.
                  </p>
                  <div className="bg-white/[0.01] border border-white/5 p-4 rounded-xl space-y-2 max-w-md">
                    ...
                    >
                      📄 Checklist de Configuração Método 3h.pdf
