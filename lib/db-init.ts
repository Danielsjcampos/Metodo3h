  ...
  try {
    ...
    if (sCount === 0) {
      ...
      const defaultSettings = [
        ["logo_text", "SITECOMIA"],
        ["seo_title", "Site Dino - Seu site profissional com IA em 3 horas"],
        ["seo_description", "Aprenda a colocar seu site no ar hoje sem precisar programar e sem pagar por hospedagem cara."],
        ...
        ["whatsapp_message", "Olá! Gostaria de saber mais sobre o método Site Dino."],
        ["launch_price", "97"],
        ["regular_price", "247"]
      ];
    ...
    if (count === 0) {
      ...
      await sql.query(
        ...
        ["u1", "Daniel Marques", "admin@sitedino.com", adminHash, "admin"]
      );

      await sql.query(
        `INSERT INTO users (id, name, email, password_hash, role) VALUES ($1, $2, $3, $4, $5)`,
        ["u2", "João Silva", "aluno@sitedino.com", memberHash, "member"]
      );
      ...
      // Seed Lessons
      const lessonsSeed = [
        ["le1", "m1", "1.1 Introdução ao Método Dino", "12:45", "https://www.w3schools.com/html/mov_bbb.mp4", 1],
      ...
      const newsSeed = [
        [
          ...
          "Sejam bem-vindos ao Site Dino! O portal oficial está 100% funcional. Preparem-se para as aulas dinâmicas e o suporte individual na nossa comunidade secreta. Nossa primeira live de mentoria será nesta quinta-feira às 20:00!", 
          "Geral", 
          true, 
