...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `Termos de Uso - ${settings.logoText || "Site Dino"}`,
    description: "Entenda os termos de uso, licença de código e regras da nossa área de membros do Site Dino.",
    icons: {
    ...
    <main className="relative min-h-screen overflow-x-hidden bg-black text-white">
      ...
      <div className="pt-32 pb-16 md:pt-40 md:pb-24 px-6 relative z-10 max-w-[1200px] mx-auto text-center">
        ...
        <p className="text-white/60 max-w-2xl mx-auto text-base md:text-lg leading-relaxed">
          Por favor, leia atentamente as diretrizes abaixo para entender suas permissões, responsabilidades e direitos ao se tornar aluno do Site Dino.
        </p>
      </div>
      ...
      <section className="pb-24 md:pb-32 px-6 relative z-10 max-w-[900px] mx-auto">
        <div className="bg-white/[0.02] border border-white/[0.08] backdrop-blur-xl rounded-2xl p-8 md:p-12 space-y-12">
          ...
          <div className="space-y-4">
            ...
            <div className="pl-11 space-y-3 text-white/75 text-sm md:text-base leading-relaxed">
              <p>
                Toda a propriedade intelectual dos códigos fornecidos, vídeos explicativos, artes gráficas e templates é propriedade exclusiva do Site Dino. Ao se tornar aluno, concedemos a você uma licença de uso limitada:
              </p>
          ...
          <div className="space-y-4">
            ...
            <div className="pl-11 space-y-3 text-white/75 text-sm md:text-base leading-relaxed">
              <p>
                O Site Dino ensina técnicas profissionais modernas utilizando as melhores práticas do mercado de desenvolvimento web acelerado por inteligência artificial. Contudo:
              </p>
              <ul className="list-disc pl-5 space-y-2 text-white/60">
