...
const targetAudience = [
  {
    ...
    description: "Você tem um negócio local — salão, clínica, oficina, loja — e não tem site, ou tem um site que ninguém acha. Quer aparecer no Google e no Maps sem depender de agência e sem custos mensais abusivos.",
  ...
  },
  {
    ...
    description: "Você quer construir uma nova fonte de renda criando sites profissionais para terceiros. Aprenda a cobrar de R$1.500 a R$3.500 por projeto em tempo recorde sem precisar digitar uma única linha de código.",
  ...
  },
  {
    ...
    subtitle: "O Futuro Profissional",
    description: "Você deseja migrar de área e surfar a maior onda digital de todos os tempos. Criar sites com auxílio de Inteligência Artificial é a porta de entrada mais veloz, lucrativa e requisitada do mercado atual.",
