            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground font-mono mb-8">
                  ...
                  <span>·</span>
                  <span className="text-[#3B82F6] font-medium">R${settings?.launchPrice || "97"} agora</span>
                  <span>·</span>
              ...
              <div className="rounded-3xl bg-white/[0.02] border border-white/10 p-8 lg:p-10 transition-all duration-500 shadow-2xl relative overflow-hidden">
                <div className="absolute -top-12 -right-12 w-[150px] h-[150px] ambient-glow-blue opacity-30 blur-[50px] pointer-events-none" />
                
                {isSuccess ? (
                  <div className="text-center py-12 px-4 space-y-6 animate-char-in relative z-10">
                    <div className="w-16 h-16 bg-[#3B82F6]/15 border border-[#3B82F6]/40 text-[#3B82F6] rounded-full flex items-center justify-center mx-auto text-3xl font-light">
                      ✓
                    </div>
                    ...
                    <div className="bg-foreground/[0.02] border border-foreground/10 py-6 px-4 rounded-xl space-y-1 max-w-xs mx-auto">
                      ...
                      <p className="text-4xl font-display text-[#3B82F6] font-semibold">#043</p>
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex items-center gap-3 mb-8 pb-6 border-b border-white/5">
                      <div className="flex items-center gap-2">
                        <span className="text-3xl font-display text-[#3B82F6]">7</span>
                      ...
                      <span className="text-muted-foreground">·</span>
                      <span className="text-sm text-[#3B82F6] font-medium">43 restantes</span>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <div>
                        ...
                        <Input 
                          ...
                          className="h-12 rounded-full bg-white/5 border-white/10 text-white placeholder:text-white/20 focus-visible:ring-1 focus-visible:ring-[#3B82F6] px-5" 
                          required
                        />
                      </div>
                      <div>
                      ...
                      <Button
                        ...
                        className="w-full bg-white hover:bg-white/95 text-black hover:shadow-[0_0_30px_rgba(255,255,255,0.25)] h-14 text-base rounded-full font-medium transition-all duration-300 group mt-6 cursor-pointer disabled:opacity-50 flex items-center justify-center"
                      >
